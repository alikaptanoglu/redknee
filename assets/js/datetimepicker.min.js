			...
			'<div class="dtp-date hidden">' +
				'<div class="dtp-month row">' +
					'<div class="col-xs-2 text-center">' +
						'<a href="javascript:void(0);" class="dtp-select-month-before"><i class="ion ion-fw ion-chevron-left"></i></a>' +
					'</div>' +
					'<div class="col-xs-8 text-center dtp-actual-month"></div>' +
					'<div class="col-xs-2 text-center">' +
						'<a href="javascript:void(0);" class="dtp-select-month-after"><i class="ion ion-fw ion-chevron-right"></i></a>' +
					'</div>' +
				'</div>' +
				'<div class="dtp-day"></div>' +
				'<div class="dtp-year row">' +
					'<div class="col-xs-2 text-center">' +
						'<a href="javascript:void(0);" class="dtp-select-year-before"><i class="ion ion-fw ion-chevron-left"></i></a>' +
					'</div>' +
				'	<div class="col-xs-8 text-center dtp-actual-year"></div>' +
					'<div class="col-xs-2 text-center">' +
						'<a href="javascript:void(0);" class="dtp-select-year-after"><i class="ion ion-fw ion-chevron-right"></i></a>' +
					'</div>' +
				'</div>' +
			'</div>' +
