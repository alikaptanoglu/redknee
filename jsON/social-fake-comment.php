...
ob_start();
?>
<div class="media" id="social-comment-<?php echo $id;?>">
		...
		<div class="row">
			<div class="col-xs-8">
				<p class="pd-5">
					...
					<a href="#" class="ajax" data-href="jsON/delete.php?id=social-comment-<?php echo $id;?>&status=confirmation"><i class="ion ion-fw ion-trash-a"></i></a>
				</p>
			</div>
...
if (strlen($message) == '') {
	...
	$array = [
		...
		"html" => [
			[
				"type" => "append",
				"target" => "this->closest(.comments)->children(.media-list)",
				"content" => $content
			]
		],
		"dom" => [
